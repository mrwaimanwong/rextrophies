...
class WC_Admin_Duplicate_vpc_configuration {
	...
	public function dupe_link( $actions, $post ) {
		...
		$actions['duplicate'] = '<a href="' . wp_nonce_url( admin_url( 'edit.php?post_type=vpc-config&action=duplicate_vpc-config&amp;post=' . absint($post->ID) ), 'woocommerce-duplicate-vpc-config_' . absint($post->ID) ) . '" title="' . __( 'Make a duplicate from this configuration', 'woocommerce' )
	...
	public function dupe_button() {
		...
		if ( isset( $_GET['post'] ) ) {
                    ...
                    $notifyUrl = wp_nonce_url( admin_url( "edit.php?post_type=vpc-config&action=duplicate_vpc-config&post=" . absint($post_id ) ), 'woocommerce-duplicate-vpc-config_' . absint($post_id) );
                    ?>
